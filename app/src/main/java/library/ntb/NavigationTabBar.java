...
import library.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    public NavigationTabBar(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        final TypedArray typedArray =
                context.obtainStyledAttributes(attrs, com.canyinpos.R.styleable.NavigationTabBar);
        try {
            setIsTitled(typedArray.getBoolean(com.canyinpos.R.styleable.NavigationTabBar_ntb_titled, false));
            setIsBadged(typedArray.getBoolean(com.canyinpos.R.styleable.NavigationTabBar_ntb_badged, false));
            setIsScaled(typedArray.getBoolean(com.canyinpos.R.styleable.NavigationTabBar_ntb_scaled, true));
            setIsTinted(typedArray.getBoolean(com.canyinpos.R.styleable.NavigationTabBar_ntb_tinted, true));
            setIsSwiped(typedArray.getBoolean(com.canyinpos.R.styleable.NavigationTabBar_ntb_swiped, true));
            setTitleSize(
                    typedArray.getDimension(com.canyinpos.R.styleable.NavigationTabBar_ntb_title_size, AUTO_SIZE)
            );
            setIsBadgeUseTypeface(
                    typedArray.getBoolean(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_use_typeface,
                            false
                    )
            );
            ...
            setTitleMode(
                    typedArray.getInt(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_title_mode, TitleMode.ALL_INDEX
                    )
            );
            setBadgeSize(
                    typedArray.getDimension(com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_size, AUTO_SIZE)
            );
            setBadgePosition(
                    typedArray.getInt(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_position,
                            BadgePosition.RIGHT_INDEX
                    )
            );
            setBadgeGravity(
                    typedArray.getInt(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_gravity, BadgeGravity.TOP_INDEX
                    )
            );
            setBadgeBgColor(
                    typedArray.getColor(com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_bg_color, AUTO_COLOR)
            );
            setBadgeTitleColor(
                    typedArray.getColor(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_badge_title_color, AUTO_COLOR
                    )
            );

            setTypeface(typedArray.getString(com.canyinpos.R.styleable.NavigationTabBar_ntb_typeface));
            setInactiveColor(
                    typedArray.getColor(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_inactive_color, DEFAULT_INACTIVE_COLOR
                    )
            );
            setActiveColor(
                    typedArray.getColor(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_active_color, DEFAULT_ACTIVE_COLOR
                    )
            );
            setBgColor(
                    typedArray.getColor(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_bg_color, DEFAULT_BG_COLOR
                    )
            );
            setAnimationDuration(
                    typedArray.getInteger(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_animation_duration,
                            DEFAULT_ANIMATION_DURATION
                    )
            );
            setCornersRadius(
                    typedArray.getDimension(com.canyinpos.R.styleable.NavigationTabBar_ntb_corners_radius, 0.0F)
            );
            setIconSizeFraction(
                    typedArray.getFloat(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_icon_size_fraction,
                            AUTO_SCALE
                    )
            );
            ...
            if (isInEditMode()) {
                ...
                try {
                    final int previewColorsId = typedArray.getResourceId(
                            com.canyinpos.R.styleable.NavigationTabBar_ntb_preview_colors, 0
                    );
                    ...
                    if (previewColors == null)
                        previewColors =
                                typedArray.getResources().getStringArray(com.canyinpos.R.array.default_preview);
...
//            mIsTitled = false;
    ...
    protected float clampValue(final float value) {
        return Math.max(
                Math.min(value, library.ntb.NavigationTabBar.MAX_FRACTION), library.ntb.NavigationTabBar.MIN_FRACTION
        );
    }
