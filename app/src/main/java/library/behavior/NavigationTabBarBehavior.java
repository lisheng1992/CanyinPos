...
public class NavigationTabBarBehavior extends library.behavior.VerticalScrollingBehavior<NavigationTabBar> {
...
// This method is intentionally empty, because of override
    ...
    public static library.behavior.NavigationTabBarBehavior from(NavigationTabBar view) {
        ...
        if (!(behavior instanceof library.behavior.NavigationTabBarBehavior))
            throw new IllegalArgumentException(
                    "The view is not associated with NavigationTabBarBehavior");

        return (library.behavior.NavigationTabBarBehavior) behavior;
    }
